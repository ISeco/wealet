...
export function FundStatsColumn({ fund, monthName, monthIncome, monthExpense }: FundStatsColumnProps) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 14, boxShadow: 'var(--shadow)', padding: '18px 20px' }}>
        <div style={{ fontSize: 12, color: 'var(--muted)' }}>Entradas en {monthName}</div>
      ...
      <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 14, boxShadow: 'var(--shadow)', padding: '18px 20px' }}>
        <div style={{ fontSize: 12, color: 'var(--muted)' }}>Salidas en {monthName}</div>
